...
async function generateAssignmentReport() {
    try {
        ...
        console.log('Requested scopes:', auth.scopes);
        console.log('Project ID:', authClient.projectId || 'Not set');

        // Explicitly refresh the token to ensure the correct scopes are applied
        console.log('Refreshing token...');
        await authClient.refreshAccessToken();
        console.log('Token refreshed successfully');

        // Get the actual scopes in the token
        const tokenInfo = await authClient.getTokenInfo(authClient.credentials.access_token);
        console.log('Actual token scopes:', tokenInfo.scopes);
